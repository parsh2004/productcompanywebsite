...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="banner">Stark Tech Group</div>
      <div class="menu">
      ...
      <div class="content">
        <div class="homecontent">
          <h1>About Us</h1>
          <img src="./img/building.jfif" alt="Building" />
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="homecontent">
          ...
          <h1>Address:</h1><br>
          <div class="contenttext">
            75/W Stark Tech Group.,<br>
            Anna Nagar,<br>
            Chennai - 600028.
          </div><br>
          <h1>Phone:</h1><br>
          <div class="contenttext">
              Mr.Rajesh  (MARKETING MANAGER): 8660177869<br><br>
              Mr.Siddharth (OPERATION MANAGER): 8896432145<br><br>
              Mr.Vijay (OFFICE MANAGER): 7384512585<br><br>
          </div>
          <h1>E-Mail:</h1>
          <div class="contenttext">
